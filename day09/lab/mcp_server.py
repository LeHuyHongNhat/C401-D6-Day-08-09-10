...
# ─────────────────────────────────────────────
# Module-level singleton + global wrappers
# Cho phép: from mcp_server import dispatch_tool, list_tools
# ─────────────────────────────────────────────

_server = MockMCPServer()

def dispatch_tool(tool_name: str, tool_input: dict) -> dict:
    result = _server.dispatch_tool(tool_name, tool_input)
    # Flatten: trả về output dict trực tiếp (giữ tương thích với policy_tool.py)
